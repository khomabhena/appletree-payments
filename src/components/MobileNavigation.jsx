  ...
  return (
    <nav className=' bg-black lg:hidden fixed px-4 top-0 z-20 left-0 right-0 md:w-[384px] bottom-0'>
      ...
      <div className=' flex justify-between h-18 items-center'>
        <img className=' cursor-pointer h-14 md:h-18 mt-4 md:mt-8 w-auto' src="/appletree-payments-logo-white.png" alt="Appletree logo" />
        <img onClick={() => {setMobileNav(!mobileNav)}} className=' cursor-pointer h-8 md:h-10' src='/close-icon-white.svg' alt='menu close button' width={'auto'} height={'32px'}  />
      </div>
