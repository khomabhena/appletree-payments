...
const UseCases = () => {
  ...
  return (
    <section id='use-cases' className=' bg-black flex flex-col items-center mt-16' style={{ color: primaryColor }}>
      <h2 className=' mt-8 text-xl md:text-2xl lg:text-3xl font-bold'>Use Cases</h2>

      <h3 style={{ color: textLight }} className=' mt-2 text-center text-xl md:text-2xl lg:text-3xl font-extralight'>We love what we do, check out some of <br />our use cases</h3>
