...
const PolicyContainer = ({ children, title }) => {
  ...
  return (
    <div className=' text-gray-900 min-h-screen w-full'>
      <nav className=' top-0 left-0 right-0 bg-black m-auto max-w-[1080px] z-20 flex justify-between items-center md:px-4 h-18'>
          <a href="/">
          ...
          <ul className=' text-lg md:text-2xl font-bold lg:flex gap-8 pr-4' style={{ color: colors.primaryColor }}>
