...
const PaymentMethods = () => {
  ...
  return (
    <section id='payment-methods' className=' flex flex-col items-center px-4 lg:px-12 pb-12' style={{ backgroundColor: colorPrimary }}>
      ...
      <section className=' payment-method-scroll mt-16 flex gap-y-4 overflow-scroll w-full gap-4 min-h-16 justify-between items-center'>
