export const getPrivacyPolicy = [
    {
        ...
        paragraphs: [
            {
                paragraph: 'This Privacy Policy is intended to inform you about how Appletree Payments collects and uses your Personal Data, as well as your rights in terms of the protection of personal data under applicable Zimbabwean national legislation. '
            },
            {
    ...
    {
        title: 'How this privacy policy affects you',
        titleNumber: '2.',
        paragraphs: [
            {
    ...
    {
        title: 'If you have registered with Appletree Payments services',
        titleNumber: '3.1',
        paragraphs: [
            {
            ...
            {
                paragraph: 'Furthermore, Appletree Payments processes payment data, account activity data and data used to manage and monitor payment fraud.'
            },
            {
                ...
                points: [
                    ...
                    {
                        point: 'For managing your personal online area;'
                    },
                    {
                        point: 'During authentication to access your account or transmit instructions for payment;'
                    },
                    {
                        point: 'For managing your requests for help or claims and'
                    },
                    {
                        point: 'To carry out the obligations in terms of the fight against money laundering and the financing of terrorism and for fraud management.'
                    }
                ]
            }
        ]
    ...
    {
        title: 'If you make a payment on an Appletree Payments payment page',
        titleNumber: '3.2',
        paragraphs: [
            {
        ...
        paragraphs: [
            {
                ...
                points: [
                    ...
                    {
                        point: 'Managing client relations (for example, providing statements of operations);'
                    },
                    {
                        point: 'Handling your questions and your potential claims;',
                    },
                    {
    ...
    {
        title: 'Appletree Payments also processes your Personal Data in the framework of legitimate interests, deemed necessary to their activity as a provider of payment services. This includes the following:',
        titleNumber: '',
        paragraphs: [
            {
                paragraph: 'The fight against identity fraud;',
            },
            {
                paragraph: 'The fight against external fraud;',
            },
            {
                paragraph: 'The fight against card payment fraud;',
            },
            {
                paragraph: 'The General Maintenance of the security of the Appletree Payments API and services.',
            },
            {
                paragraph: 'Finally, Appletree Payments manages your data for legal purposes. This includes but is not limited to:',
                points: [
                    {
                        point: 'Respecting the legal and regulatory obligations imposed on Appletree Payments in their capacity as a provider of payment services, and specifically in terms of the fight against money laundering and the financing of terrorism;'
                    },
                    {
                        point: 'Cooperating with public authorities and any authority in charge of applying the law or prudential supervision, in the event of oversight or inquiry.'
                    }
                ]
            },
        ],
    ...
    {
        title: 'The appropriate authorities',
        titleNumber: '7.2',
        paragraphs: [
            {
    ...
    },
    {
        ...
        paragraphs: [
            {
                paragraph: 'If you are aware that the Data pertaining to you is inexact or incomplete, you have the right to request that this Data be rectified or updated.'
            }
        ]
    },
    {
        ...
        paragraphs: [
            {
                paragraph: 'In compliance with applicable regulations, you may request erasure of your Data in the following cases:',
                points: [
                    {
                        point: 'When it is no longer necessary for the purposes for which it has been collected or processed;'
                    },
                    {
                        point: 'When your Data has been subject to illegal processing or when it must be erased to comply with a legal obligation.'
                    }
                ]
    ...
    },
    {
        ...
        paragraphs: [
            {
                paragraph: 'You have the right to request that data processing be restricted in the following cases:',
                points: [
                    {
                        point: 'If you contest the accuracy of your Personal Data;'
                    },
                    {
    ...
    {
        title: 'Right to object to data processing',
        titleNumber: '8.5',
        paragraphs: [
            {
                paragraph: 'If you have a legitimate reason, you may object to your Data being processed. When you object to data processing, your Data will no longer be processed for these purposes.'
            }
        ]
    },
    {
        title: 'Right of portability of Data',
        titleNumber: '8.6',
        paragraphs: [
            {
                paragraph: 'You have a right of portability of the Data that you have transmitted. You may also receive the Data in a structured format, currently used and readable by machine. You also have the right to request that this Data be transmitted to another data processor, when this is technically possible.'
            }
        ]
    },
    {
        ...
        paragraphs: [
            {
                paragraph: 'You may exercise your rights by contacting the Partner of Appletree Payments with which you are in a relationship according to the terms indicated on their website, or by directly contacting Appletree Payments at the following address: legal@appletreepayments.com. '
            },
            {
                paragraph: 'For any request to exercise your rights, Appletree Payments may request you provide an official identity document in order to verify that you are the individual to whom the Data subject to the request relates. '
            },
            {
                paragraph: 'Responses to your requests will be communicated to you electronically, unless you request otherwise. In this case, you must include in your request the form you wish your response to take.'
            },
            {
                paragraph: 'Appletree Payments undertakes to respond to all requests immediately. You will receive a response in a maximum time frame of one month from the receipt of your request. However, we inform you that this time frame may be extended to two months if your request is particularly complex or has multiple requests. In this case, you will be informed of such an extension and the reasons thereof in a maximum time frame of one month from the receipt of your request.'
            },
            {
                paragraph: 'If Appletree Payments is not able to respond to your request, you will be informed at the latest in a time frame of one month from the receipt of your request, including the reasons for this. You will then have the possibility of filing a claim with a supervisory authority and to initiate legal proceedings.'
            },
            {
                paragraph: 'You are informed that in the event of manifestly unfounded or excessive requests, specifically in terms of their repetitive nature, we may refuse to respond to your requests or require that fees be paid that take into account the administrative costs borne by responding to your requests.'
            }
        ]
    },
    {
        title: 'How is your Personal Data secured?',
        titleNumber: '10.',
        paragraphs: [
            {
    ...
    {
        title: 'What is the relationship between Appletree Payments and its Partners for managing your Personal Data?',
        titleNumber: '11.',
        paragraphs: [
            {
    ...
    },
    {
        ...
        paragraphs: [
            {
                paragraph: "Modifications to the Privacy Policy are published on Appletree Payments website with an indication of the last update. Modifications to data processing managed and jointly assumed with a Partner will also be communicated to you according to the terms established in this document"
            },
        ],
    },
]